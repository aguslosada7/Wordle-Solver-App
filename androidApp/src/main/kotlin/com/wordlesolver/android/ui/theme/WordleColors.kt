...
object WordleColors {
    ...
    val Black = Color(0xFF0E081A)
    val InputDarkBackground = Color(0xFF19112D)
    val ResultBackground = Color(0xFFEBE7F4)
    val ResultDarkBackground = Color(0xFF1E1736)
    val WordleWordBackground = Color(0xFFB9B0D4)
    val RepeatedAnswerBackground = Color(0xFFE3C989)
    val RepeatedAnswerBackgroundDark = Color(0xFFCB8838)
    val TitleDark = Color(0xFF2D2150)
    val TitleLight = Color(0xFF8177A9)
    val WordCardBorder = Color(0xFFC9C0E0)
    val WordCardText = Color(0xFF3A3358)
    val ColorblindCorrect = Color(0xFFF5793A)
    val ColorblindMisplaced = Color(0xFF85C0F9)
}